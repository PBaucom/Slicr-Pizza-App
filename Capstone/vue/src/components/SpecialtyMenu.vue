  ...
  <form id="pizza-form" v-on:submit.prevent="addPizza()">
    <table class="wp-table">
      ...
      <div id="app">
        ...
        <p v-show="!this.cart.empty" id="selected">
          <b>Pizza In Cart</b>: {{ selected }}
        </p>
      </div>
    </table>
    ...
    <div
      v-show="
        selected == 'Build Your Own S 9.99' ||
        selected == 'Build Your Own M 11.99' ||
        selected == 'Build Your Own L 13.99'
      "
    >
    ...
    <button type="button" v-on:click="emptyCart()" value="Empty Cart">
      Empty Cart
    </button>
    <button type="button" v-on:click="checkout()" value="Checkout">
      Checkout
    </button>
  </form>
</template>
